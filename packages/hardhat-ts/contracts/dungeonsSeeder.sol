...
/// https://etherscan.io/address/0xd2806cce4be35ae7b84a25d11b5c2f1a6deeedcb#code
...
contract dungeonsSeeder {
  ...
  string[12] people = ["Fate's", "Fohd's", "Gremp's", "Hate's", "Kali's", "Kiv's", "Light's", "Shub's", "Sol's", "Tish's", "Viper's", "Woe's"];
  ...
  function getSeed(uint256 tokenId) external view returns (uint256) {
    ...
    uint256 seed = uint256(keccak256(abi.encodePacked(blockhash(block.number - 1), tokenId, tx.gasprice)));
    return (seed);
  }
